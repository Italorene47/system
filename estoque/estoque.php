...
if(mysqli_num_rows($res) > 0) {
    ...
    while($row = $res-> fetch_object()){
        ...
        echo "<td> <button onclick=\"location.href='inventario.php?acao=inventario&id_produto=".$row->id_produto."';\" 
        class='btn btn-primary'> Inventário </button> " . "</td>";
        echo "</tr>";
    }
    echo "</table>";
